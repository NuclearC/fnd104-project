...
շատ են սիրում:"
    ...
    with Dissolve(4.0)
    m "Նրանց շները պատառոտում էին մեզ, ամեն կողպեքը կախած փակ դռան ետևը նրանք իրենց գամփռներին էին դրել։"
    play sound "krakoc.mp3"
    ...
    menu:
        ...
        "Մատնել":
            ...
            if girl_killed == False:
                ...
                m "Երբ զինվոր աղջիկը տեսավ փոքրին, նրանք վազեցին իրար գրկեցին։ Նրանց աչքերը լի էին արցունքներով, բայց դրանց խորքում՝ փոքրիկ հույս կար։ Նրանք գրկում էին միմյանց, ասես մոռացած լինեն ամեն ինչ։"
    ...
    if girl2_hog_tanel == True:
        ...
        m "Նա արդեն մի քիչ ուշքի էր եկել, հետս ամեն անգամ երկու բառ էր փոխանակում։"
        s "․․․"
    ...
    Shahen "Ամբողջ գիշերը կտուրից ձեներ էն գալիս, ուղիղ մեր բազայի դիմացն է։ Էդ տունը չպիտի մնա, կմիամտվենք, ու մի օր թշնամին կբարձրանա կտուր:"
